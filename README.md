...
- **Данис Низамов** – *Backend, Security*
- **Петр Харламов** – *Аутентификация JWT, База данных*
...
- Затем в терминале нужно написать команду, чтобы установить все нужные пакеты
```json
